...
/** @brief Set overflow 4ms, prescaler 001 --> 1 */
#define TIM1_OVF_4MS   TCCR1B &= ~((1<<CS02) | (1<<CS10)); TCCR0B |= (1<<CS00);
/** @brief Set overflow 33ms, prescaler 010 --> 8 */
#define TIM1_OVF_33MS  TCCR1B &= ~((1<<CS02) | (1<<CS00)); TCCR0B |= (1<<CS01);
/** @brief Set overflow 262ms, prescaler 011 --> 64 */
#define TIM1_OVF_262MS TCCR1B &= ~(1<<CS02); TCCR0B |= (1<<CS01) | (1<<CS00);
/** @brief Set overflow 1s, prescaler 100 --> 256 */
#define TIM1_OVF_1SEC  TCCR1B &= ~((1<<CS01) | (1<<CS00)); TCCR0B |= (1<<CS02);
/** @brief Set overflow 4s, prescaler // 101 --> 1024 */
#define TIM1_OVF_4SEC  TCCR1B &= ~(1<<CS01); TCCR0B |= (1<<CS02) | (1<<CS00);
...
/** @brief Enable overflow interrupt, 1 --> enable */
#define TIM1_OVF_ENABLE  TIMSK1 |= (1<<TOIE01);
/** @brief Disable overflow interrupt, 0 --> disable */
#define TIM1_OVF_DISABLE TIMSK1 &= ~(1<<TOIE0);
